  ...
  const steps = [
    {
      ...
      instructions: [
              ...
              <div className="flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-8">
                ...
                <div className="text-center">
                  ...
                  <div className="text-purple-400 text-xs">
                    24/7 Hosting • Free Tier
                  </div>
                </div>

                {/* Arrow */}
                <div className="text-purple-400 text-2xl hidden md:block">
                  ⇄
                </div>
        ...
        },
        {
          ...
          copyValue: {
            label: 'GitHub CLI Quickstart Guide',
            value:
              'https://docs.github.com/en/github-cli/github-cli/quickstart',
            id: 'github-cli-quickstart',
          },
        },
        {
      ...
      copyValues: [
        {
          label: 'GitHub CLI Installation Guide',
          value: 'https://docs.github.com/en/cli/installation',
          id: 'github-cli-install',
        },
        {
          label: 'GitHub CLI Usage Guide',
          value: 'https://docs.github.com/en/cli',
          id: 'github-cli-docs',
        },
        {
          label: 'GitHub Signup (if needed)',
    ...
    },
    {
      ...
      instructions: [
        ...
        },
        {
          ...
          copyValue: {
            label: 'Example Neon Connection String',
            value: 'postgresql://user:password@ep-example.neon.tech/dbname',
            id: 'neon-conn',
          },
        },
      ],
      ...
      instructions: [
        {
          ...
          copyValue: {
            label: 'Swarm Repository URL',
            value: 'https://github.com/HiveTalk/swarm',
            id: 'swarm-url',
          },
        },
        {
        ...
        },
        {
          ...
          copyValue: {
            label: 'Clone Command (replace YOUR_USERNAME)',
            value: 'git clone https://github.com/YOUR_USERNAME/swarm.git',
            id: 'git-clone',
          },
        },
        {
        ...
        },
        {
          ...
          substeps: ['Type: git checkout main', 'Press Enter'],
        },
      ],
    },
    {
      ...
      instructions: [
        {
          ...
          copyValues: [
            {
              label: 'Mac install (brew)',
              value: 'brew install flyctl',
              id: 'brew-install',
            },
            {
              label: 'Windows install (winget)',
              value: 'winget install --id SuperFly.FlyCTL',
              id: 'winget-install',
            },
            {
              label: 'Linux install (curl)',
              value: 'curl -L https://fly.io/install.sh | sh',
              id: 'curl-install',
            },
            {
              label: 'Fly.io CLI docs',
              value: 'https://fly.io/docs/hands-on/install-flyctl/',
              id: 'flyctl-docs',
            },
          ],
        },
        ...
        },
        {
          ...
          copyValue: {
            label: 'Login to Fly.io',
            value: 'flyctl auth login',
            id: 'flyctl-login',
          },
        },
        {
...
git push`,
        ...
        },
        {
          ...
          copyValue: {
            ...
            value:
              'flyctl secrets set DATABASE_URL="postgresql://user:password@host:5432/dbname?sslmode=disable"',
            id: 'flyio-secrets',
          },
        },
        {
    ...
    },
    {
      ...
      instructions: [
        ...
        },
        {
          ...
          copyValue: {
            label: 'Test endpoint (replace your-app)',
        ...
        },
        {
          ...
          copyValue: {
            label: 'WebSocket URL (replace your-app)',
        ...
        },
        {
          ...
          copyValues: [
            {
              label: 'Jumble.social URL',
              value: 'https://jumble.social',
              id: 'jumble-url',
            },
            {
              label: 'Nostr Debug Query Tool',
              value: 'https://nostrdebug.com/query',
              id: 'nostr-debug-query',
            },
          ],
        },
        {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-slate-300 mb-2">
            Setup guide for Fly.io + Neon DB
          </p>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    >
                      <div>
                        <h2
                          className={`text-xl font-bold ${completedSteps[step.num] ? 'text-green-400 line-through' : 'text-white'}`}
                        >
                          {step.num === 0 ? '' : `Step ${step.num}: `}
                          {step.title}
                        </h2>
                  ...
                  {(step.videoSrc ||
                    ...
                    <div className="space-y-2">
                          ...
                          <div className="w-full h-full bg-slate-700 flex items-center justify-center">
                            <div className="text-center">
                              ...
                              <p className="text-xs text-slate-500 mt-1">
                                Replace videoId in code with your YouTube video
                                ID
                              </p>
                            </div>
                          </div>
                      ...
                      <p className="text-xs text-slate-400">
                        💡 Tip: Watch the video first, then follow the text
                        instructions below
                      </p>
                    </div>
                  )}
                      ...
                      >
                        ...
                        <ul className="space-y-2 ml-4 mb-4">
                          {instruction.substeps.map((substep, subidx) => (
                            <li
                              key={subidx}
                              className="flex items-start space-x-2 text-slate-200 text-sm"
                            >
                              <span className="text-slate-500 font-bold mt-0.5">
                                •
                              </span>
                              <span
                        ...
                        {/* Inline diagram */}
                        {instruction.diagram && (
                          <div className="mt-4">{instruction.diagram}</div>
                        )}
                            ...
                            {(instruction.copyValue
                              ...
                              >
                                <div className="flex items-stretch space-x-2">
                                  ...
                                  <button
                                    onClick={() =>
                                      copyToClipboard(copyVal.value, copyVal.id)
                                    }
        ...
        <div className="mt-12 bg-slate-800 border border-slate-700 rounded-lg p-6">
          ...
          <div className="space-y-3 text-slate-300 text-sm">
            <p>
              Your relay currently runs at{' '}
              <code className="bg-slate-900 px-2 py-1 rounded text-green-400">
                wss://swarm-relay-xxx.fly.dev
              </code>
            </p>
            <p className="font-semibold text-blue-300 mb-2">
              To use your own domain (e.g., wss://relay.yoursite.com):
            </p>
            <ol className="list-decimal list-inside space-y-2">
              <li>
                Run:{' '}
                <code className="bg-slate-900 px-2 py-1 rounded text-green-400 text-xs">
                  flyctl certs add relay.yoursite.com
                </code>
              </li>
              <li>
                Fly.io gives you a CNAME record to add to your domain registrar
              </li>
              <li>
                Add the CNAME to your DNS settings (GoDaddy, Namecheap, etc.)
              </li>
          ...
          <div className="space-y-3 text-slate-300 text-sm">
            <div>
              <p className="font-semibold text-blue-300 mb-1">
                ❌ App won&apos;t start / connection errors
              </p>
              <p>
                Check logs with:{' '}
                <code className="bg-slate-900 px-2 py-1 rounded text-green-400 text-xs">
              ...
              <p>
                Most common: Wrong Neon credentials. Verify POSTGRES_HOST,
                POSTGRES_PASSWORD, and POSTGRES_USER are exactly correct.
              </p>
            </div>
            <div>
              <p className="font-semibold text-blue-300 mb-1">
              ...
              <p>
                Database connection failed. Check that all POSTGRES_* variables
                are set correctly and your Neon database is active (not in sleep
                mode).
              </p>
            </div>
            <div>
              ...
              <p>
                Verify DB_ENGINE is set to &quot;postgres&quot; and
                POSTGRES_PORT is 5432. Check Neon is awake and your credentials
                are correct.
              </p>
            </div>
            <div>
              <p className="font-semibold text-blue-300 mb-1">
                ❌ Want to redeploy immediately?
              </p>
              <p>
                Run:{' '}
                <code className="bg-slate-900 px-2 py-1 rounded text-green-400 text-xs">
        ...
        {Object.values(completedSteps).filter(Boolean).length ===
          ...
          <div className="mt-8 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500 rounded-lg p-6 text-center">
            ...
            <p className="text-green-300">
              Your Nostr relay is live and running 24/7!
            </p>
            <p className="text-sm text-green-200 mt-2">
              Cost: $0/month • Uptime: 24/7 (750 hours/month free)
            </p>
            <p className="text-sm text-green-200 mt-3">
              Ready to add media storage? Upgrade to a VPS for ~$7-10/month to
